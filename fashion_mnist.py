...
from dataset import load_fashion_mnist, imshow
...
#Change to size of Resnet pre-trained model
...
for epoch in range(num_epoch):
    ...
    for i, batch in enumerate(trainloader, 0):
        ...
        images, labels = batch
        images = preprocess(images) #Ressize Image
